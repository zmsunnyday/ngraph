...
{
    auto arg_0 = op::Parameter::create(element::f32, Shape{});
    auto arg_1 = op::Parameter::create(element::f32, Shape{});
    auto arg_2 = op::Parameter::create(element::f32, Shape{});
    auto arg_3 = op::Parameter::create(element::f32, Shape{});
    auto arg_4 = op::Parameter::create(element::f32, Shape{});
    auto arg_5 = op::Parameter::create(element::f32, Shape{});
