...
{
    // Deduce type
    auto param = op::Parameter::create(element::f32, Shape{2, 4});
...
{
    // Deduce type
    auto param0 = op::Parameter::create(element::f32, Shape{2, 3, 4});
    auto param1 = op::Parameter::create(element::f32, Shape{2, 7, 4});
    auto param2 = op::Parameter::create(element::f32, Shape{2, 2, 4});
...
TEST(type_prop, concat_deduce_wrong_rank)
{
    auto param0 = op::Parameter::create(element::f32, Shape{2, 3, 4});
    auto param1 = op::Parameter::create(element::f32, Shape{2, 7, 4});
    auto param2 = op::Parameter::create(element::f32,
                                        Shape{
                                            2, 2,
                                        });
    try
...
TEST(type_prop, concat_deduce_wrong_shape)
{
    auto param0 = op::Parameter::create(element::f32, Shape{2, 3, 4});
    auto param1 = op::Parameter::create(element::f32, Shape{2, 7, 4});
    auto param2 = op::Parameter::create(element::f32, Shape{2, 2, 5});
    try
    {
        auto c = make_shared<op::Concat>(Nodes{param0, param1, param2}, 1);
        // Should have thrown, so fail if it didn't
...
TEST(type_prop, concat_deduce_axis_barely_in_bounds)
{
    // Deduce type
    auto param0 = op::Parameter::create(element::f32, Shape{2, 3, 4});
    auto param1 = op::Parameter::create(element::f32, Shape{2, 3, 8});
    auto param2 = op::Parameter::create(element::f32, Shape{2, 3, 12});
...
{
    auto param0 = op::Parameter::create(element::f32, Shape{2, 3, 4});
    auto param1 = op::Parameter::create(element::i32, Shape{2, 7, 4});
    auto param2 = op::Parameter::create(element::f32, Shape{2, 2, 4});
    try
    {
        auto c = make_shared<op::Concat>(Nodes{param0, param1, param2}, 1);
...
{
    // Deduce type
    auto param = op::Parameter::create(element::f32, Shape{2, 3, 4});
...
TEST(type_prop, dot_deduce_scalar_2d)
{
    ...
    auto param1 = op::Parameter::create(element::f32, Shape{});
    auto param2 = op::Parameter::create(element::f32, Shape{4, 5});
...
TEST(type_prop, dot_deduce_2d_scalar)
{
    ...
    auto param1 = op::Parameter::create(element::f32, Shape{4, 5});
    auto param2 = op::Parameter::create(element::f32, Shape{});
    auto bc = make_shared<op::Dot>(param1, param2);
    ASSERT_EQ(bc->get_element_type(), element::f32);
    ASSERT_EQ(bc->get_shape(), (Shape{4, 5}));
}
...
TEST(type_prop, dot_deduce_scalar_1d)
{
    ...
    auto param1 = op::Parameter::create(element::f32, Shape{});
    auto param2 = op::Parameter::create(element::f32, Shape{6});
    auto bc = make_shared<op::Dot>(param1, param2);
    ASSERT_EQ(bc->get_element_type(), element::f32);
...
TEST(type_prop, dot_deduce_1d)
{
    ...
    auto param1 = op::Parameter::create(element::f32, Shape{4});
    auto param2 = op::Parameter::create(element::f32, Shape{4});
    auto bc = make_shared<op::Dot>(param1, param2);
    ASSERT_EQ(bc->get_element_type(), element::f32);
    ASSERT_EQ(bc->get_shape(), (Shape{}));
}
...
TEST(type_prop, dot_deduce_2d)
{
    ...
    auto param1 = op::Parameter::create(element::f32, Shape{4, 2});
    auto param2 = op::Parameter::create(element::f32, Shape{2, 3});
    auto bc = make_shared<op::Dot>(param1, param2);
    ASSERT_EQ(bc->get_element_type(), element::f32);
...
TEST(type_prop, dot_deduce_different_rank)
{
    ...
    auto param1 = op::Parameter::create(element::f32, Shape{2, 8, 4, 2});
    auto param2 = op::Parameter::create(element::f32, Shape{2, 1, 3});
    auto bc = make_shared<op::Dot>(param1, param2);
    ASSERT_EQ(bc->get_element_type(), element::f32);
...
TEST(type_prop, dot_deduce_element_type_mismatch)
{
    ...
    auto param1 = op::Parameter::create(element::f32, Shape{4, 2});
    auto param2 = op::Parameter::create(element::i32, Shape{2, 5});
    try
    {
        auto bc = make_shared<op::Dot>(param1, param2);
        // Should have thrown, so fail if it didn't
...
TEST(type_prop, dot_deduce_reduction_axes_size_mismatch)
{
    ...
    auto param1 = op::Parameter::create(element::f32, Shape{4, 2});
    auto param2 = op::Parameter::create(element::f32, Shape{3, 5});
    try
    {
        auto bc = make_shared<op::Dot>(param1, param2);
        // Should have thrown, so fail if it didn't
                 ...
                 shared_ptr<Node>(f)(const shared_ptr<Node>& x, const shared_ptr<Node>& y))
{
    ...
    auto tv0_2_4_param_0 = op::Parameter::create(element::f32, Shape{2, 4});
    auto tv0_2_4_param_1 = op::Parameter::create(element::f32, Shape{2, 4});
    auto tv0_2_4_param_2 = op::Parameter::create(element::i32, Shape{2, 4});
    auto tv0_4_2_param = op::Parameter::create(element::f32, Shape{4, 2});
...
{
    auto tv0_2_4_param_0 = op::Parameter::create(element::boolean, Shape{2, 4});
    auto tv0_2_4_param_1 = op::Parameter::create(element::boolean, Shape{2, 4});
    try
    {
...
{
    auto tv0_2_4_param = op::Parameter::create(element::boolean, Shape{2, 4});
    try
    {
...
TEST(type_prop, select_deduce)
{
    auto tv0_2_4_param_0 = op::Parameter::create(element::boolean, Shape{2, 4});
    auto tv0_2_4_param_1 = op::Parameter::create(element::f32, Shape{2, 4});
    auto tv0_2_4_param_2 = op::Parameter::create(element::f32, Shape{2, 4});
...
{
    auto tv0_2_4_param_0 = op::Parameter::create(element::boolean, Shape{3, 5});
    auto tv0_2_4_param_1 = op::Parameter::create(element::f32, Shape{2, 4});
    auto tv0_2_4_param_2 = op::Parameter::create(element::f32, Shape{2, 4});
    try
    {
...
{
    auto tv0_2_4_param_0 = op::Parameter::create(element::boolean, Shape{2, 4});
    auto tv0_2_4_param_1 = op::Parameter::create(element::f32, Shape{3, 5});
    auto tv0_2_4_param_2 = op::Parameter::create(element::f32, Shape{2, 4});
    try
    {
        auto bc = make_shared<op::Select>(tv0_2_4_param_0, tv0_2_4_param_1, tv0_2_4_param_2);
...
TEST(type_prop, select_shape_mismatch_c)
{
    auto tv0_2_4_param_0 = op::Parameter::create(element::boolean, Shape{2, 4});
    auto tv0_2_4_param_1 = op::Parameter::create(element::f32, Shape{2, 4});
    auto tv0_2_4_param_2 = op::Parameter::create(element::f32, Shape{3, 5});
    try
    {
        auto bc = make_shared<op::Select>(tv0_2_4_param_0, tv0_2_4_param_1, tv0_2_4_param_2);
        // Should have thrown, so fail if it didn't
...
{
    auto param_0 = op::Parameter::create(element::f32, Shape{2, 4});
    auto param_1 = op::Parameter::create(element::f32, Shape{});

    auto f_param_0 = op::Parameter::create(element::f32, Shape{});
    auto f_param_1 = op::Parameter::create(element::f32, Shape{});
...
{
    auto param_0 = op::Parameter::create(element::f32, Shape{2, 4});
    auto param_1 = op::Parameter::create(element::f32, Shape{2});
...
{
    auto param_0 = op::Parameter::create(element::f32, Shape{2, 4});
    auto param_1 = op::Parameter::create(element::boolean, Shape{});
...
TEST(type_prop, reduce_function_arg0_type_mismatch)
{
    ...
    auto f_param_0 = op::Parameter::create(element::boolean, Shape{});
    auto f_param_1 = op::Parameter::create(element::f32, Shape{});
...
TEST(type_prop, reduce_function_arg1_type_mismatch)
{
    ...
    auto f_param_0 = op::Parameter::create(element::f32, Shape{});
    auto f_param_1 = op::Parameter::create(element::boolean, Shape{});
...
TEST(type_prop, reduce_function_arg_count_mismatch)
{
    ...
    auto f_param_0 = op::Parameter::create(element::f32, Shape{});
    auto f_param_1 = op::Parameter::create(element::f32, Shape{});
    auto f_param_2 = op::Parameter::create(element::f32, Shape{});
...
{
    auto param = op::Parameter::create(element::f32, Shape{1});
...
{
    auto param = op::Parameter::create(element::f32, Shape{1, 1});
...
{
    auto param = op::Parameter::create(element::f32, Shape{1, 1, 1});
...
{
    auto param = op::Parameter::create(element::f32, Shape{3, 4});
...
{
    auto param = op::Parameter::create(element::f32, Shape{3, 4, 5});
...
{
    auto param = op::Parameter::create(element::f32, Shape{6});
...
{
    auto param = op::Parameter::create(element::f32, Shape{6, 8});
...
{
    auto param0 = op::Parameter::create(element::f32, Shape{6});
    auto param1 = op::Parameter::create(element::f32, Shape{3});
...
{
    auto param0 = op::Parameter::create(element::f32, Shape{6, 8});
    auto param1 = op::Parameter::create(element::f32, Shape{3, 6});
...
{
    auto param0 = op::Parameter::create(element::f32, Shape{6, 8});
    auto param1 = op::Parameter::create(element::f32, Shape{1, 3});
...
{
    auto param0 = op::Parameter::create(element::f32, Shape{6, 8});
    auto param1 = op::Parameter::create(element::f32, Shape{1, 2});
    auto rsl = make_shared<op::ReplaceSlice>(
...
{
    auto param0 = op::Parameter::create(element::f32, Shape{6});
    auto param1 = op::Parameter::create(element::f32, Shape{6});
...
{
    auto param0 = op::Parameter::create(element::f32, Shape{6, 8});
    auto param1 = op::Parameter::create(element::f32, Shape{6, 8});
...
{
    auto param0 = op::Parameter::create(element::f32, Shape{6, 8});
    auto param1 = op::Parameter::create(element::f32, Shape{6, 0});
...
{
    auto param0 = op::Parameter::create(element::f32, Shape{6, 8});
    auto param1 = op::Parameter::create(element::f32, Shape{0, 0});
...
{
    auto param0 = op::Parameter::create(element::f32, Shape{6, 8});
    auto param1 = op::Parameter::create(element::f32, Shape{3, 6, 5});
    try
    {
        auto rsl =
...
{
    auto param0 = op::Parameter::create(element::f32, Shape{6, 8});
    auto param1 = op::Parameter::create(element::i32, Shape{3, 6});
    try
    {
        auto rsl =
            make_shared<op::ReplaceSlice>(param0, param1, Coordinate{2, 1}, Coordinate{5, 7});
...
{
    auto param0 = op::Parameter::create(element::f32, Shape{6, 8});
    auto param1 = op::Parameter::create(element::f32, Shape{4, 6});
    try
    {
        auto rsl = make_shared<op::ReplaceSlice>(
...
{
    auto param0 = op::Parameter::create(element::f32, Shape{6});
    auto param1 = op::Parameter::create(element::f32, Shape{7});
    try
    {
...
{
    auto param0 = op::Parameter::create(element::f32, Shape{6, 8});
    auto param1 = op::Parameter::create(element::f32, Shape{6, 9});
    try
    {
        auto rsl =
...
{
    auto param0 = op::Parameter::create(element::f32, Shape{6});
    auto param1 = op::Parameter::create(element::f32, Shape{0});
    try
    {
...
{
    auto param0 = op::Parameter::create(element::f32, Shape{6, 8});
    auto param1 = op::Parameter::create(element::f32, Shape{6, 6});
    try
    {
...
{
    auto param = op::Parameter::create(element::i32, Shape{});
...
{
    auto param = op::Parameter::create(element::i32, Shape{8});
...
{
    auto param = op::Parameter::create(element::i32, Shape{12, 24});
...
{
    auto param = op::Parameter::create(element::f32, Shape{12, 24});
...
{
    // Deduce type
    auto param0 = op::Parameter::create(element::f32, Shape{64, 3, 100});
    auto param1 = op::Parameter::create(element::f32, Shape{128, 3, 10});
...
TEST(type_prop, conv_1d_back_data_batch_deduce)
{
    ...
    auto param0 = op::Parameter::create(element::f32, Shape{128, 3, 10});  // filters
    auto param1 = op::Parameter::create(element::f32, Shape{64, 128, 91}); // output delta
...
TEST(type_prop, conv_1d_back_filters_deduce)
{
    ...
    auto param0 = op::Parameter::create(element::f32, Shape{64, 3, 100});  // data batch
    auto param1 = op::Parameter::create(element::f32, Shape{64, 128, 91}); // output delta
...
TEST(type_prop, conv_1d_back_data_batch_deduce_padded)
{
    ...
    Shape data_batch_shape{64, 3, 100};
    auto param0 = op::Parameter::create(element::f32, Shape{128, 3, 10});  // filters
    auto param1 = op::Parameter::create(element::f32, Shape{64, 128, 96}); // output delta
    auto move_strides = Strides{1};
    auto dilation_strides = Strides{1};
    auto padding_below = CoordinateDiff{2};
    auto padding_above = CoordinateDiff{3};
...
TEST(type_prop, conv_1d_back_data_batch_deduce_strided)
{
    ...
    Shape data_batch_shape{64, 3, 100};
    auto param0 = op::Parameter::create(element::f32, Shape{128, 3, 10});  // filters
    auto param1 = op::Parameter::create(element::f32, Shape{64, 128, 46}); // output delta
    auto move_strides = Strides{2};
    auto conv = make_shared<op::ConvolutionBackpropData>(data_batch_shape,
                                                         param0,
                                                         param1,
...
TEST(type_prop, conv_1d_back_data_batch_deduce_strided_padded)
{
    ...
    Shape data_batch_shape{64, 3, 100};
    auto param0 = op::Parameter::create(element::f32, Shape{128, 3, 10});  // filters
    auto param1 = op::Parameter::create(element::f32, Shape{64, 128, 48}); // output delta
    auto move_strides = Strides{2};
    auto dilation_strides = Strides{1};
    auto padding_below = CoordinateDiff{2};
    auto padding_above = CoordinateDiff{3};
...
{
    // Deduce type
    auto param0 = op::Parameter::create(element::f32, Shape{64, 3, 5});
    auto param1 = op::Parameter::create(element::f32, Shape{128, 3, 2});
    auto move_strides = Strides{2};
    auto conv = make_shared<op::Convolution>(param0, param1, move_strides);
    EXPECT_EQ(conv->get_element_type(), element::f32);
...
TEST(type_prop, conv_1d_back_data_batch_deduce_strided_small_uneven)
{
    ...
    auto param0 = op::Parameter::create(element::f32, Shape{128, 3, 2});  // filters
    auto param1 = op::Parameter::create(element::f32, Shape{64, 128, 2}); // output delta
    auto move_strides = Strides{2};
    auto conv = make_shared<op::ConvolutionBackpropData>(data_batch_shape,
                                                         param0,
                                                         param1,
...
TEST(type_prop, conv_1d_back_filters_deduce_strided_small_uneven)
{
    ...
    auto param0 = op::Parameter::create(element::f32, Shape{64, 3, 5});   // data batch
    auto param1 = op::Parameter::create(element::f32, Shape{64, 128, 2}); // output delta
    auto move_strides = Strides{2};
    auto conv = make_shared<op::ConvolutionBackpropFilters>(param0,
                                                            filters_shape,
...
{
    // Deduce type
    auto param0 = op::Parameter::create(element::f32, Shape{64, 3, 6});
    auto param1 = op::Parameter::create(element::f32, Shape{128, 3, 2});
    auto move_strides = Strides{2};
    auto conv = make_shared<op::Convolution>(param0, param1, move_strides);
    EXPECT_EQ(conv->get_element_type(), element::f32);
...
TEST(type_prop, conv_1d_back_data_batch_deduce_strided_small_even)
{
    ...
    auto param0 = op::Parameter::create(element::f32, Shape{128, 3, 2});  // filters
    auto param1 = op::Parameter::create(element::f32, Shape{64, 128, 3}); // output delta
    auto move_strides = Strides{2};
    auto conv = make_shared<op::ConvolutionBackpropData>(data_batch_shape,
                                                         param0,
                                                         param1,
...
TEST(type_prop, conv_1d_back_filters_deduce_strided_small_even)
{
    ...
    //Shape data_batch_shape{64, 3, 6};
    Shape filters_shape{128, 3, 2};
    auto param0 = op::Parameter::create(element::f32, Shape{64, 3, 6});   // data batch
    auto param1 = op::Parameter::create(element::f32, Shape{64, 128, 3}); // output delta
    auto move_strides = Strides{2};
    auto conv = make_shared<op::ConvolutionBackpropFilters>(param0,
                                                            filters_shape,
...
TEST(type_prop, conv_1d_back_data_batch_deduce_window_dilated)
{
    ...
    Shape data_batch_shape{64, 3, 100};
    auto param0 = op::Parameter::create(element::f32, Shape{128, 3, 10});  // filters
    auto param1 = op::Parameter::create(element::f32, Shape{64, 128, 82}); // output delta
    auto move_strides = Strides{1};
    auto dilate_strides = Strides{2};
    auto conv = make_shared<op::ConvolutionBackpropData>(data_batch_shape,
                                                         param0,
...
TEST(type_prop, conv_1d_back_data_batch_deduce_window_dilated_padded)
{
    ...
    Shape data_batch_shape{64, 3, 100};
    auto param0 = op::Parameter::create(element::f32, Shape{128, 3, 10});  // filters
    auto param1 = op::Parameter::create(element::f32, Shape{64, 128, 87}); // output delta
    auto move_strides = Strides{1};
    auto dilate_strides = Strides{2};
    auto padding_below = CoordinateDiff{2};
    auto padding_above = CoordinateDiff{3};
...
TEST(type_prop, conv_1d_back_data_batch_deduce_window_dilated_data_dilated_padded)
{
    ...
    Shape data_batch_shape{64, 3, 100};
    auto param0 = op::Parameter::create(element::f32, Shape{128, 3, 10});   // filters
    auto param1 = op::Parameter::create(element::f32, Shape{64, 128, 285}); // output delta
    auto move_strides = Strides{1};
    auto dilate_strides = Strides{2};
    auto padding_below = CoordinateDiff{2};
    auto padding_above = CoordinateDiff{3};
...
{
    // Deduce type
    auto param0 = op::Parameter::create(element::f32, Shape{64, 3, 100, 150});
    auto param1 = op::Parameter::create(element::f32, Shape{128, 3, 10, 20});
    auto conv = make_shared<op::Convolution>(param0, param1);
    EXPECT_EQ(conv->get_element_type(), element::f32);
...
{
    // Deduce type
    auto param0 = op::Parameter::create(element::f32, Shape{64, 3, 7, 8});
    auto param1 = op::Parameter::create(element::f32, Shape{128, 3, 2, 3});
    auto move_strides = Strides{2, 3};
    auto dilate_strides = Strides{3, 2};
    auto conv = make_shared<op::Convolution>(param0, param1, move_strides, dilate_strides);
    EXPECT_EQ(conv->get_element_type(), element::f32);
...
{
    // Deduce type
    auto param0 = op::Parameter::create(element::f32, Shape{64, 3, 7, 8, 10});
    auto param1 = op::Parameter::create(element::f32, Shape{128, 3, 2, 3, 2});
...
{
    // Deduce type
    auto param0 = op::Parameter::create(element::f32, Shape{3, 3, 3, 3});
    auto param1 = op::Parameter::create(element::i32, Shape{3, 3, 2, 2});
    try
    {
        auto conv = make_shared<op::Convolution>(param0, param1);
...
{
    // Deduce type
    auto param0 = op::Parameter::create(element::f32, Shape{});
    auto param1 = op::Parameter::create(element::f32, Shape{});
    try
    {
        auto conv = make_shared<op::Convolution>(param0, param1);
...
{
    // Deduce type
    auto param0 = op::Parameter::create(element::f32, Shape{2});
    auto param1 = op::Parameter::create(element::f32, Shape{2});
    try
    {
        auto conv = make_shared<op::Convolution>(param0, param1);
...
{
    // Deduce type
    auto param0 = op::Parameter::create(element::f32, Shape{2, 6});
    auto param1 = op::Parameter::create(element::f32, Shape{2, 6});
    try
    {
        auto conv = make_shared<op::Convolution>(param0, param1);
...
{
    // Deduce type
    auto param0 = op::Parameter::create(element::f32, Shape{0, 6, 1});
    auto param1 = op::Parameter::create(element::f32, Shape{0, 6, 1});
    try
    {
        auto conv = make_shared<op::Convolution>(param0, param1);
...
{
    // Deduce type
    auto param0 = op::Parameter::create(element::f32, Shape{6, 0, 1});
    auto param1 = op::Parameter::create(element::f32, Shape{5, 0, 1});
    try
    {
        auto conv = make_shared<op::Convolution>(param0, param1);
...
{
    // Deduce type
    auto param0 = op::Parameter::create(element::f32, Shape{6, 2, 10, 10});
    auto param1 = op::Parameter::create(element::f32, Shape{5, 2, 3, 3, 3});
    try
    {
        auto conv = make_shared<op::Convolution>(param0, param1);
...
TEST(type_prop, conv_invalid_wrong_number_of_filter_dimensions_too_few)
{
    // Deduce type
    auto param0 = op::Parameter::create(element::f32, Shape{6, 2, 10, 10});
    auto param1 = op::Parameter::create(element::f32, Shape{5, 2, 3});
    try
    {
        auto conv = make_shared<op::Convolution>(param0, param1);
...
TEST(type_prop, conv_invalid_0_output_channels)
{
    // Deduce type
    auto param0 = op::Parameter::create(element::f32, Shape{6, 2, 10, 10});
    auto param1 = op::Parameter::create(element::f32, Shape{0, 2, 3, 3});
    try
    {
        auto conv = make_shared<op::Convolution>(param0, param1);
...
TEST(type_prop, conv_invalid_input_channel_mismatch)
{
    // Deduce type
    auto param0 = op::Parameter::create(element::f32, Shape{6, 2, 10, 10});
    auto param1 = op::Parameter::create(element::f32, Shape{6, 3, 3, 3});
    try
    {
        auto conv = make_shared<op::Convolution>(param0, param1);
...
TEST(type_prop, conv_invalid_movement_stride_rank)
{
    // Deduce type
    auto param0 = op::Parameter::create(element::f32, Shape{6, 2, 10, 10});
    auto param1 = op::Parameter::create(element::f32, Shape{6, 2, 3, 3});
    try
    {
...
{
    // Deduce type
    auto param0 = op::Parameter::create(element::f32, Shape{6, 2, 0, 10});
    auto param1 = op::Parameter::create(element::f32, Shape{6, 2, 3, 3});
    try
    {
        auto conv = make_shared<op::Convolution>(param0, param1);
...
TEST(type_prop, conv_invalid_window_size_0)
{
    // Deduce type
    auto param0 = op::Parameter::create(element::f32, Shape{6, 2, 10, 10});
    auto param1 = op::Parameter::create(element::f32, Shape{6, 2, 3, 0});
    try
    {
        auto conv = make_shared<op::Convolution>(param0, param1);
...
{
    // Deduce type
    auto param0 = op::Parameter::create(element::f32, Shape{6, 2, 8, 8});
    auto param1 = op::Parameter::create(element::f32, Shape{6, 2, 3, 3});
    try
    {
...
{
    // Deduce type
    auto param = op::Parameter::create(element::f32, Shape{64, 3, 100});
...
{
    // Deduce type
    auto param = op::Parameter::create(element::f32, Shape{64, 3, 5});
...
{
    // Deduce type
    auto param = op::Parameter::create(element::f32, Shape{64, 3, 6});
    Shape window_shape{2};
    auto move_strides = Strides{2};
    auto max_pool = make_shared<op::MaxPool>(param, window_shape, move_strides);
...
{
    // Deduce type
    auto param = op::Parameter::create(element::f32, Shape{64, 3, 100, 150});
...
{
    // Deduce type
    auto param = op::Parameter::create(element::f32, Shape{64, 3, 7, 8, 10});
...
{
    // Deduce type
    auto param = op::Parameter::create(element::f32, Shape{2});
    Shape window_shape{};
    try
    {
        auto max_pool = make_shared<op::MaxPool>(param, window_shape);
...
{
    // Deduce type
    auto param = op::Parameter::create(element::f32, Shape{2, 6});
    Shape window_shape{};
    try
    {
        auto max_pool = make_shared<op::MaxPool>(param, window_shape);
...
{
    // Deduce type
    auto param = op::Parameter::create(element::f32, Shape{0, 6, 1});
...
{
    // Deduce type
    auto param = op::Parameter::create(element::f32, Shape{6, 0, 1});
    Shape window_shape{1};
    try
    {
        auto max_pool = make_shared<op::MaxPool>(param, window_shape);
...
{
    // Deduce type
    auto param = op::Parameter::create(element::f32, Shape{6, 2, 10, 10});
...
{
    // Deduce type
    auto param = op::Parameter::create(element::f32, Shape{6, 2, 0, 10});
    Shape window_shape{3, 3};
    try
    {
        auto max_pool = make_shared<op::MaxPool>(param, window_shape);
...
{
    // Deduce type
    auto param = op::Parameter::create(element::f32, Shape{6, 2, 8, 8});
...
{
    // Deduce type
    auto param = op::Parameter::create(element::f32, Shape{5});
    auto rev = make_shared<op::Reverse>(param, AxisSet{});
...
{
    // Deduce type
    auto param = op::Parameter::create(element::f32, Shape{5, 6});
    auto rev = make_shared<op::Reverse>(param, AxisSet{});
...
{
    // Deduce type
    auto param = op::Parameter::create(element::f32, Shape{5, 6, 7});
    auto rev = make_shared<op::Reverse>(param, AxisSet{});
...
{
    auto param_0 = op::Parameter::create(element::f32, Shape{16});
    auto param_1 = op::Parameter::create(element::f32, Shape{});
...
{
    auto param_0 = op::Parameter::create(element::f32, Shape{18});
    auto param_1 = op::Parameter::create(element::f32, Shape{});
...
{
    auto param_0 = op::Parameter::create(element::f32, Shape{18, 10});
    auto param_1 = op::Parameter::create(element::f32, Shape{});
...
{
    auto param_0 = op::Parameter::create(element::f32, Shape{18, 10, 15});
    auto param_1 = op::Parameter::create(element::f32, Shape{});
...
{
    auto param_0 = op::Parameter::create(element::f32, Shape{18, 10, 15});
    auto param_1 = op::Parameter::create(element::f32, Shape{3});
...
{
    auto param_0 = op::Parameter::create(element::f32, Shape{18, 10, 15});
    auto param_1 = op::Parameter::create(element::i32, Shape{});
...
TEST(type_prop, reduce_window_deduce_param_0_wrong_element_type)
{
    ...
    auto f_param_0 = op::Parameter::create(element::i32, Shape{});
    auto f_param_1 = op::Parameter::create(element::f32, Shape{});
    auto f = make_shared<Function>(f_param_1, op::Parameters{f_param_0, f_param_1});
...
TEST(type_prop, reduce_window_deduce_param_0_wrong_shape)
{
    ...
    auto f_param_0 = op::Parameter::create(element::f32, Shape{1});
    auto f_param_1 = op::Parameter::create(element::f32, Shape{});
    auto f = make_shared<Function>(f_param_1, op::Parameters{f_param_0, f_param_1});
...
TEST(type_prop, reduce_window_deduce_param_1_wrong_element_type)
{
    ...
    auto f_param_0 = op::Parameter::create(element::f32, Shape{});
    auto f_param_1 = op::Parameter::create(element::i32, Shape{});
    auto f = make_shared<Function>(f_param_0, op::Parameters{f_param_0, f_param_1});
...
TEST(type_prop, reduce_window_deduce_param_1_wrong_shape)
{
    ...
    auto f_param_0 = op::Parameter::create(element::f32, Shape{});
    auto f_param_1 = op::Parameter::create(element::f32, Shape{1});
    auto f = make_shared<Function>(f_param_0, op::Parameters{f_param_0, f_param_1});
...
{
    auto param_0 = op::Parameter::create(element::f32, Shape{16});
    auto param_1 = op::Parameter::create(element::f32, Shape{13});
    auto param_2 = op::Parameter::create(element::f32, Shape{});
    ...
    auto g_param_0 = op::Parameter::create(element::f32, Shape{});
    auto g_param_1 = op::Parameter::create(element::f32, Shape{});
...
{
    auto param_0 = op::Parameter::create(element::f32, Shape{16, 18});
    auto param_1 = op::Parameter::create(element::f32, Shape{13, 14});
    auto param_2 = op::Parameter::create(element::f32, Shape{});
...
{
    auto param_0 = op::Parameter::create(element::f32, Shape{16, 18, 10});
    auto param_1 = op::Parameter::create(element::f32, Shape{13, 14, 9});
    auto param_2 = op::Parameter::create(element::f32, Shape{});
...
{
    auto param_0 = op::Parameter::create(element::f32, Shape{16, 18, 10});
    auto param_1 = op::Parameter::create(element::f32, Shape{4, 3, 2});
    auto param_2 = op::Parameter::create(element::f32, Shape{});
...
{
    auto param_0 = op::Parameter::create(element::f32, Shape{16, 18, 10});
    auto param_1 = op::Parameter::create(element::f32, Shape{2, 3, 3});
    auto param_2 = op::Parameter::create(element::f32, Shape{});
...
TEST(type_prop, select_and_scatter_deduce_init_not_scalar)
{
    auto param_0 = op::Parameter::create(element::f32, Shape{16, 18, 10});
    auto param_1 = op::Parameter::create(element::f32, Shape{2, 3, 3});
    auto param_2 = op::Parameter::create(element::f32, Shape{4});
...
TEST(type_prop, select_and_scatter_deduce_init_elem_type_wrong)
{
    auto param_0 = op::Parameter::create(element::f32, Shape{16, 18, 10});
    auto param_1 = op::Parameter::create(element::f32, Shape{2, 3, 3});
    auto param_2 = op::Parameter::create(element::i32, Shape{});
...
{
    auto param_0 = op::Parameter::create(element::f32, Shape{16, 18, 10});
    auto param_1 = op::Parameter::create(element::i32, Shape{2, 3, 3});
    auto param_2 = op::Parameter::create(element::f32, Shape{});
...
{
    auto param_0 = op::Parameter::create(element::f32, Shape{16, 18, 10});
    auto param_1 = op::Parameter::create(element::f32, Shape{2, 4, 3});
    auto param_2 = op::Parameter::create(element::f32, Shape{});
...
TEST(type_prop, select_and_scatter_deduce_scatter_function_wrong_param_count)
{
    ...
    auto g_param_0 = op::Parameter::create(element::f32, Shape{});
    auto g_param_1 = op::Parameter::create(element::f32, Shape{});
    auto g_param_2 = op::Parameter::create(element::f32, Shape{});
...
TEST(type_prop, select_and_scatter_deduce_scatter_function_wrong_param_0_element_type)
{
    ...
    auto g_param_0 = op::Parameter::create(element::i32, Shape{});
    auto g_param_1 = op::Parameter::create(element::f32, Shape{});
...
TEST(type_prop, select_and_scatter_deduce_scatter_function_wrong_param_0_shape)
{
    ...
    auto g_param_0 = op::Parameter::create(element::f32, Shape{1});
    auto g_param_1 = op::Parameter::create(element::f32, Shape{});
    auto g = make_shared<Function>(g_param_1 + g_param_1, op::Parameters{g_param_0, g_param_1});
...
TEST(type_prop, select_and_scatter_deduce_scatter_function_wrong_param_1_element_type)
{
    ...
    auto g_param_0 = op::Parameter::create(element::f32, Shape{});
    auto g_param_1 = op::Parameter::create(element::i32, Shape{});
...
TEST(type_prop, select_and_scatter_deduce_scatter_function_wrong_param_1_shape)
{
    ...
    auto g_param_0 = op::Parameter::create(element::f32, Shape{});
    auto g_param_1 = op::Parameter::create(element::f32, Shape{1});
    auto g = make_shared<Function>(g_param_0 + g_param_0, op::Parameters{g_param_0, g_param_1});
...
{
    // Deduce type
    auto param0 = op::Parameter::create(element::f32, Shape{50});
    auto param1 = op::Parameter::create(element::f32, Shape{});
...
{
    // Deduce type
    auto param0 = op::Parameter::create(element::f32, Shape{50, 40});
    auto param1 = op::Parameter::create(element::f32, Shape{});
...
{
    // Deduce type
    auto param0 = op::Parameter::create(element::f32, Shape{50, 40, 20});
    auto param1 = op::Parameter::create(element::f32, Shape{});
...
TEST(type_prop, pad_deduce_element_type_mismatch)
{
    // Deduce type
    auto param0 = op::Parameter::create(element::f32, Shape{50, 40, 20});
    auto param1 = op::Parameter::create(element::i32, Shape{});
    Shape padding_below{5, 3, 0};
    Shape padding_above{6, 9, 4};
    Shape padding_interior{2, 3, 0};
    try
