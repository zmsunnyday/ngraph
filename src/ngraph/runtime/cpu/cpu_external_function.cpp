...
void runtime::cpu::CPU_ExternalFunction::compile()
{
    ...
    writer.add_include("cstring");
    writer.add_include("ngraph/except.hpp");
    writer.add_include("ngraph/runtime/aligned_buffer.hpp");
    writer.add_include("ngraph/runtime/cpu/cpu_kernels.hpp");
    writer.add_include("ngraph/runtime/cpu/cpu_runtime_context.hpp");
    writer.add_include("ngraph/runtime/cpu/mkldnn_invoke.hpp");
    writer.add_include("ngraph/runtime/kernel/avg_pool.hpp");
    writer.add_include("ngraph/runtime/kernel/broadcast.hpp");
    writer.add_include("ngraph/runtime/kernel/concat.hpp");
    writer.add_include("ngraph/runtime/kernel/convolution.hpp");
    writer.add_include("ngraph/runtime/kernel/dot.hpp");
    writer.add_include("ngraph/runtime/kernel/max.hpp");
    writer.add_include("ngraph/runtime/kernel/max_pool.hpp");
    writer.add_include("ngraph/runtime/kernel/min.hpp");
    writer.add_include("ngraph/runtime/kernel/not.hpp");
    writer.add_include("ngraph/runtime/kernel/one_hot.hpp");
    writer.add_include("ngraph/runtime/kernel/pad.hpp");
    writer.add_include("ngraph/runtime/kernel/product.hpp");
    writer.add_include("ngraph/runtime/kernel/reduce.hpp");
    writer.add_include("ngraph/runtime/kernel/reduce_window.hpp");
    writer.add_include("ngraph/runtime/kernel/relu.hpp");
    writer.add_include("ngraph/runtime/kernel/replace_slice.hpp");
    writer.add_include("ngraph/runtime/kernel/reshape.hpp");
    writer.add_include("ngraph/runtime/kernel/reverse.hpp");
    writer.add_include("ngraph/runtime/kernel/select_and_scatter.hpp");
    writer.add_include("ngraph/runtime/kernel/slice.hpp");
    writer.add_include("ngraph/runtime/kernel/sum.hpp");
    writer.add_include("ngraph/util.hpp");
    ...
    if (m_use_tbb)
    {
        writer.add_include("tbb/flow_graph.h");
    }
    ...
    string pch_header_source = writer.get_headers();
