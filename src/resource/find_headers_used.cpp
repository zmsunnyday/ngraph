...
vector<HeaderInfo> FindHeadersUsed::collect_headers(const string& source)
{
    ...
    {
        rc.push_back({include.second, include.first});
    }

    return rc;
}

void FindHeadersUsed::configure_search_path()
{
...
void FindHeadersUsed::add_header_search_path(const string& path)
{
...
bool FindHeadersUsed::is_version_number(const string& path)
{
    bool rc = true;
